...
pub use reference::{
    backfill_from_init, current_git_branch, drift_summary, ensure_morph_in_git_info_exclude,
    git_head_sha, git_log_range, git_parents, handle_post_checkout, handle_post_rewrite,
    ...
    sync_to_head_with_origin, CheckoutOutcome, DriftSummary, GitCommitInfo, HookInstallReport,
